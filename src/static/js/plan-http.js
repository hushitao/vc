...
service.interceptors.request.use(
  config => {
    ...
    if (config.url) {
      ...
      //   case 'production':
      //     config.url =
      //       'http://innerapi-zt.laiyifen.com/scm-plan-service' + reqUrl
      //     config.headers['X-Co-Client'] = '11F2B1577EE8473CA8D5C2C1E7DB9F82'
      //     break
      //   case 'development':
      //     config.url = reqUrl
